...
def standardize_column_names_complete(df):
    ...
    for col in df.columns:
        ...
        elif 'уни наименование' in clean_col or 'товар' in clean_col or 'наименование' in clean_col:
...
def scan_files():
    ...
    try:
        ...
        for file in all_files:
            ...
            if file.startswith('pyaterochka_') and file.endswith('.csv') and os.path.isfile(file_path):
